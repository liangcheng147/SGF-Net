...
experiment = {
    ...
    "visualization": False,
    "visualization_types": ["heatmap", "srm_analysis", "tsne", "gate_analysis", "case_study"],
    "visualization_path": "/home/yons/artificial/rine-main/results/keshihua",
}


def get_gangen_dwt_model(device):
    rine_model = Model(
...
def main():
    ...
    model = get_gangen_dwt_model(device)
    model.to(device)
